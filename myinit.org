...
#+END_SRC
** Which-key
A package that displays the available keybindings in a popup. The
...
** helpful
Improves *help* buffer. Way more info than with regular help.
...
** Diredfl
Adding more colors to dired buffers
#+BEGIN_SRC emacs-lisp
(use-package diredfl
  :ensure t
  :after (dired)
...
#+END_SRC
** Dired-subtree
Dired-subtree is a package that enables managing Dired buffers in a
tree-like manner.
...
#+END_SRC
** Dired-git-info
[[https://github.com/clemera/dired-git-info][dired-git-info]]. This Emacs packages provides a minor mode which shows
