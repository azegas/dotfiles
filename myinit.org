...
#+BEGIN_SRC emacs-lisp
  (fset 'irc_emacs
   ...
   macro." (interactive "p") (kmacro-exec-ring-item (quote ([134217848
                                                             114 backspace 101 114 99 32 116 108 return return return
                                                             return return 106 111 backspace backspace 47 106 111 105 110
                                                             32 35 101 109 97 99 115 return 72 101 108 108 111 32 101 118
                                                             101 114 121 111 110 101 33 return] 0 "%d")) arg)))
#+END_SRC
5 min tasks taken from all my agenda files.
