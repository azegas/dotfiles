...
#+BEGIN_SRC emacs-lisp
  (fset 'duplicate_clock_in
        [tab ?\C-n ?\C-n ?\C-a ?\C-k ?\C-k ?\C-k ?\C-k ?\C-p ?\C-p tab ?\C-e ?\C-a ?\C-  ?\C-e ?\C-f ?\M-w return ?\C-a ?\C-a ?\C-y ?\C-p ?\C-p ?\C-c ?\C-t ?r tab ?\C-n tab ?\C-n ?\C-k ?\C-k ?\C-p ?\C-x ?\C-s ?\C-c ?\C-x ?\C-i])
#+END_SRC
