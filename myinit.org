...
#+BEGIN_SRC emacs-lisp
  ;; ;Backups
  (setq backup-directory-alist '(("." . "~/Dropbox/documents/org/backups/emacs_backups/")))
#+END_SRC
* Projectile
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-agenda-files '("~/Dropbox/documents/org/personal/seima.org"
                           "~/Dropbox/documents/org/personal/inbox.org"
                           "~/Dropbox/documents/org/personal/diary.org"))
...
("i" "Inbox" entry (file+headline "~/Dropbox/documents/org/personal/inbox.org" "Inbox")"* %i%?")
("s" "Seima" entry (file+headline "~/Dropbox/documents/org/personal/seima.org" "Seima to-do")"* %i%?")
("d" "Diary" entry (file+datetree "~/Dropbox/documents/org/personal/diary.org" "Diary") "* %U %^{Title} %?")))
