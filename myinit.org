...
#+END_SRC
** My-comment-box
<2022-03-18 Pn> I got this code from pragmaticemacs:
#+BEGIN_SRC emacs-lisp
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ;; example:                                                                ;;
...
m-x customise-variable RET org-log-into-drawer - select LOGBOOK save
and apply.
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-capture-templates '(
                                ...
                                ("s" "Smuti Fruti" entry (file+headline "~/Dropbox/documents/org/smuti_fruti.org" "Smuti_Fruti") "* TODO %?\n%^{Effort}p")
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Automatically copy (or move) completed tasks to dailies from here -
  ;; https://systemcrafters.net/build-a-second-brain-in-emacs/5-org-roam-hacks/
  ;; This might be nice, BUT then it also copies my habits, which are
  ;; files with loads of info under them... don't really want to clutter
  ;; my org-roam files with that unnecessary information. Should I get
  ;; rid of org-habits to accommodate THIS feature? Is it even that
  ;; good? How it is more beneficial to store notes in archive, nice and
  ;; tidy AS WELL AS in org-roam daily files? Daily file overview sounds
  ;; very nice. See what and how much time I have spend on activities
  ;; that day. And then also if I want to see how much time I have spend
  ;; on "project x", I can just go to archive and sum the time there.
  ;; And about the habits.. I guess I have to get rid of them. Not
  ;; really a big deal, I think I should rid some habits, since I have
  ;; been repeating them for a long time already. So.. at the end, it's
  ;; good that I discovered this method below, I get a chance to clean
  ;; up my org-habis :)
...
#+END_SRC
<2022-03-17 Kt> Macro for adding emacs-lisp code block called
#+BEGIN_SRC emacs-lisp
(fset 'hack
   (lambda (&optional arg) "Keyboard macro." (interactive "p") (kmacro-exec-ring-item (quote ([60 115 tab 101 109 97 99 115 45 108 105 115 112 14 3 39] 0 "%d")) arg)))
#+END_SRC
...
* OFF - Lsp-mode
  ...
  linting error checking on the right, signature help(tells what
