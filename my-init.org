* DONE convert from .el to .org
CLOSED: [2023-03-18 Sat 07:42]
* DONE check which packages need to be turned on and which should be off according to the old onef
CLOSED: [2023-03-18 Sat 07:42]
* DONE Delete elpa folder and install only what is in your config
CLOSED: [2023-03-18 Sat 07:42]

* DONE Isskaidyk kiekviena configa i gabalelius pagal temas, kad butu aiskiau kur kas tarp headings
CLOSED: [2023-03-18 Sat 08:00]
* TODO write shortcuts to all packages
