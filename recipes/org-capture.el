...
(cond ((eq system-type 'windows-nt)
      ...
      ((eq system-type 'gnu/linux)
       ...
       (setq org-capture-templates
             '(("i" "INBOX")
               ("ii" "INBOX QUICK" entry (file+headline "~/Dropbox/org/notes/inbox.org" "inbox")
                "* TODO %?\n:PROPERTIES:\n:Created: %U\n:END:\n" :prepend t :created t)
               ("ia" "INBOX su aprasymu" entry (file+headline "~/Dropbox/org/notes/inbox.org" "inbox")
                "* TODO %^{Todo} \n:PROPERTIES:\n:Created: %U\n:END:\n\n%?\n- %a" :prepend t :created t)
               ("s" "SOMEDAY")
               ("ss" "SOMEDAY SCHEDULED" entry (file+headline "~/Dropbox/org/notes/inbox.org" "With Timestamp")
                "* SOMEDAY %?\n  SCHEDULED: %^t\n  :PROPERTIES:\n  :CAPTURED: %U\n  :END:\n\n- %a" :prepend t)
               ("sn" "SOMEDAY NON-SCHEDULED" entry (file+headline "~/Dropbox/org/notes/inbox.org" "With Timestamp")
                "* SOMEDAY %?\n :PROPERTIES:\n  :CAPTURED: %U\n  :END:\n\n- %a" :prepend t)
               ("sd" "SOMEDAY DEADLINE" entry (file+headline "~/Dropbox/org/notes/inbox.org" "With Timestamp")
                "* SOMEDAY %?\n  DEADLINE: %^t\n  :PROPERTIES:\n  :CAPTURED: %U\n  :END:\n\n- %a" :prepend t)
               ))
       )
      )
...
;; (setq org-capture-templates
;;       '(("1" "10min" plain (file+headline "~/Dropbox/org/notes/inbox.org" "Inbox")
;;          "** 10min %?")
